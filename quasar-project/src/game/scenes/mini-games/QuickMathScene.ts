...
export default class QuickMathScene extends BaseScene implements IMiniGame {
  ...
  constructor() {
    super(SCENE_KEYS.MINI_GAMES.MATH);
  }
  ...
  create(): void {
    ...
    // Placeholder - Quick Math game implementation to be added later
